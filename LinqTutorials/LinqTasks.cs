...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            int result = Enumerable.Max(from emp in Emps
                select emp.Salary);
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = from emp in Emps
                where emp.Salary == Enumerable.Max(from emp2 in Emps select emp2.Salary)
                select emp;
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            IEnumerable<string> enumerable = new[] { "Brak wartości", null, null };
            return result.Union(enumerable);
        }
        ...
        {
            IEnumerable<Emp> result = Emps.GetEmpsWithSubordinates2();
            return result;
        }
        ...
        {
            int result = 0;
            result = (from number in arr
                group arr by number into g
                where g.Count() % 2 == 1
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            result = from dept in Depts
                join emp in Emps on dept.Deptno equals emp.Deptno into gj
                from subgroup in gj.DefaultIfEmpty()
                group subgroup by dept
                into g
                where g.Count() == 0 || g.Count() == 5
                orderby g.Key.Dname ascending
                select g.Key;
            return result;
        }
        ...
        public static IEnumerable<object> Task15()
        {
            ...
            result = from emp in Emps
                where emp.Job.Length >= 3 && emp.Job.Substring(1, emp.Job.Length - 2).Contains('A')
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> GetEmpsWithSubordinates2(this IEnumerable<Emp> emps)
        {
            var result = from emp in emps
                    where (from emp2 in emps select emp2.Mgr).Any()
